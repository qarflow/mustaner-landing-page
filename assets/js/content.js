/* Bilingual copy deck for the Mustaner landing page.
   Edit a string here and it updates both the page and the language toggle.
   Generated from the approved copy deck — keys must stay identical in en and ar. */
window.MUSTANER_COPY = {
 "en": {
  "meta": {
  ...
  "quickinfo": {
   ...
   "fees_note": "Early Bird, down from 15,000 EGP. Seats are limited."
  },
  "ui": {
   "nav_items": [
    {
  ...
  "audience": {
   ...
   "roles": [
    {
     "title": "CEOs",
     "body": "You are accountable for a number you cannot reach by working harder, and you need a strategy the whole company can be measured against."
    },
    {
     "title": "Founders",
     "body": "The business grew on your instinct and your relationships, and it has now outgrown both."
    },
    {
     "title": "Business Owners",
     "body": "You want growth that does not depend on you being in every meeting, and a plan you can hand to someone else."
    },
    {
     "title": "Senior Managers",
     "body": "You are being asked to think beyond your function, and you need the frameworks senior conversations are actually held in."
    },
    {
     "title": "Heads of Departments",
     "body": "Your department delivers, but you cannot always show how its targets connect to where the company is going."
    },
    {
     "title": "Growth / Strategy / Execution Leaders",
     "body": "You own the plan on paper and are judged on whether it survives the quarter."
    }
   ],
   "not_for_label": "Who this is not for",
   ...
   "items": [
    {
     ...
     "a": "The frameworks, models and materials carry their standard English names — PESTEL, Porter's Five Forces, SWOT/TOWS, Value Chain, BCG, Ansoff, OKRs, KPIs, Balanced Scorecard — as they are used in practice. For confirmation on the language used in the room itself, message us on WhatsApp at +20 109 271 8547 before you book."
    },
    {
     "q": "Do I need a formal strategy background?",
     "a": "No. Session 1 starts at the line between strategic and operational planning, then builds the pillars — vision, mission, values, objectives — before any tool is introduced. What the programme assumes is decision-making responsibility, not prior strategy training: CEOs, founders, business owners, senior managers and heads of departments accountable for growth or execution."
    },
    {
    ...
    },
    {
     ...
     "a": "Applied. Each framework is worked through on real case studies, exercises and business simulations drawn from live client projects, which is how the programme bridges theory and execution. You leave able to run the tools, not describe them."
    },
    {
     "q": "Can I book several seats for my team?",
     "a": "Mustaner runs corporate training and company initiatives alongside the open programme, so a team booking is straightforward. Terms for multiple seats are agreed case by case — send the number of people and their roles to +20 109 271 8547 and the team will come back to you."
    },
    {
     "q": "Can I pay in instalments?",
     "a": "Three payment routes are confirmed: Fawaterk card payment, bank transfer to Arab African International Bank, and Vodafone Cash. Instalment terms are not published — if you need to split the fee, ask on WhatsApp at +20 109 271 8547 before you book and you will get a straight answer."
    },
    {
     "q": "How is the AI part different from a generic AI course?",
     "a": "It is not a tour of AI tools. Four of the ten sessions run AI against strategy work you have already done by hand in the first six: AI-powered PESTEL, Porter's Five Forces, SWOT, TOWS and Value Chain analysis; AI scenario planning and opportunity mapping; AI-driven OKRs, KPIs, Balanced Scorecards, roadmaps and dashboards. The judgement comes first, the acceleration second."
    },
    {
  ...
  "testimonials": [
   {
    ...
    "name": "Menna",
    "role": "Participant, previous round",
    "initials": "M"
   },
   {
    "quote": "I will not even start on how good and how simplified the explanation was. Every point we discussed together and understood together — and every point we took, we applied, then discussed what we had done.",
    "name": "Malak",
    "role": "Participant, previous round",
    "initials": "M"
   },
   {
    "quote": "Eng. Fouad’s sessions were honestly among the ones I enjoyed most in the whole programme. His explanation is very smooth, he repeats things as many times as we need, and he never tires of us.",
    "name": "Maryam Mohamed Salah",
    "role": "Participant, previous round",
    "initials": "MS"
   },
   {
    "quote": "Dr. Fouad was genuinely an inspiring person for us. His approach, his method and his willingness to help were all at a high level.",
    "name": "Fatma Alzahraa",
    "role": "Participant, previous round",
    "initials": "FA"
   },
   {
    "quote": "A thousand thanks for the excellent organisation and the outstanding material. I genuinely benefited — the way it organises your thinking overall is excellent.",
    "name": "Eng. Youssef Hassan",
    "role": "Participant, previous round",
    "initials": "YH"
   },
   {
    "quote": "Special thanks to Dr. Ahmed Magraby for how easy and completely clear the material was, and to everyone who helped make the course turn out this well.",
    "name": "Ahmed Shama",
    "role": "Participant, previous round",
    "initials": "AS"
   }
...
"quickinfo": {
   "cells": [
    ...
    {
     "label": "المدة",
     "value": "40 ساعة · 10 جلسات"
    },
    {
     "label": "طريقة الحضور",
     "value": "حضوري · وجهًا لوجه"
    },
    {
     "label": "المكان",
   ...
   "fees_note": "سعر الحجز المبكر بدلًا من 15,000 جنيه. المقاعد محدودة."
  },
  "ui": {
   "nav_items": [
    {
  ...
  "audience": {
   ...
   "roles": [
    {
     "title": "CEOs",
     "body": "أنت مسؤول عن رقم لن تصل إليه بمزيد من العمل، وتحتاج استراتيجية تُقاس الشركة كلها عليها."
    },
    {
     "title": "Founders",
     "body": "نمت الشركة بحدسك وعلاقاتك، وقد تجاوزت الاثنين الآن."
    },
    {
     "title": "أصحاب الأعمال",
     "body": "تريد نموًا لا يتوقف على وجودك في كل اجتماع، وخطة تستطيع تسليمها لغيرك."
    },
    {
     "title": "كبار المديرين",
     "body": "يُطلب منك التفكير خارج حدود إدارتك، وتحتاج الأطر التي تُدار بها حوارات القيادة فعليًا."
    },
    {
     "title": "رؤساء الإدارات",
     "body": "إدارتك تُنجز، لكنك لا تستطيع دائمًا إظهار كيف ترتبط أهدافها بوجهة الشركة."
    },
    {
     "title": "قادة النمو والاستراتيجية والتنفيذ",
     "body": "أنت تملك الخطة على الورق، وتُحاسَب على صمودها حتى نهاية الربع."
    }
   ],
   "not_for_label": "لمن لا يصلح هذا البرنامج",
  ...
  "schedule": {
   ...
   "summary_cells": [
    ...
    {
     "label": "الأيام",
     "value": "الاثنين والأربعاء"
    },
    {
     "label": "التوقيت",
     "value": "6:00 مساءً – 10:00 مساءً"
    },
    {
     "label": "الإجمالي",
     "value": "40 ساعة · 10 جلسات"
  ...
  "faq": {
   ...
   "items": [
    {
     "q": "ما لغة تقديم البرنامج؟",
     "a": "النماذج والأدوات والمواد تحمل مسمياتها الإنجليزية المتعارف عليها — PESTEL وPorter's Five Forces وSWOT/TOWS وValue Chain وBCG وAnsoff وOKRs وKPIs وBalanced Scorecard — كما تُستخدم في الممارسة العملية. ولتأكيد لغة الشرح داخل القاعة نفسها، راسلنا على WhatsApp على +20 109 271 8547 قبل الحجز."
    },
    {
     "q": "هل أحتاج خلفية سابقة في الاستراتيجية؟",
     "a": "لا. الجلسة الأولى تبدأ من الفارق بين التخطيط الاستراتيجي والتشغيلي، ثم تبني الركائز — الرؤية والرسالة والقيم والأهداف — قبل عرض أي أداة. ما يفترضه البرنامج هو مسؤولية اتخاذ القرار، لا دراسة سابقة للاستراتيجية: CEOs وFounders وأصحاب الأعمال وكبار المديرين ورؤساء الإدارات المسؤولين عن النمو أو التنفيذ."
    },
    {
    ...
    },
    {
     ...
     "a": "تطبيقي. كل أداة يتم العمل عليها من خلال حالات دراسية حقيقية وتمارين ومحاكاة أعمال مأخوذة من مشروعات عملاء فعلية، وهو ما يجعل البرنامج جسرًا بين النظرية والتنفيذ. تخرج قادرًا على تشغيل الأدوات، لا على وصفها."
    },
    {
     "q": "هل يمكنني حجز أكثر من مقعد لفريقي؟",
     "a": "مُسْتَنِير تقدّم تدريبًا للشركات ومبادرات مؤسسية بجانب البرنامج المفتوح، لذلك حجز فريق كامل أمر مباشر. شروط المقاعد المتعددة يتم الاتفاق عليها حالة بحالة — أرسل عدد الأشخاص ومناصبهم على +20 109 271 8547 وسيعود إليك الفريق."
    },
    {
     "q": "هل يمكن الدفع على أقساط؟",
     "a": "ثلاث طرق دفع مؤكدة: الدفع بالكارت عبر Fawaterk، والتحويل البنكي إلى البنك العربي الأفريقي الدولي، وVodafone Cash. شروط التقسيط غير معلنة — فإن كنت تحتاج تقسيم قيمة الاشتراك، اسأل على WhatsApp على +20 109 271 8547 قبل الحجز وستحصل على إجابة واضحة."
    },
    {
     "q": "ما الفارق بين جلسات AI هنا وأي تدريب AI عام؟",
     "a": "ليست جولة على أدوات AI. أربع جلسات من العشرة تُشغّل AI على عمل استراتيجي أنجزته بيدك في الجلسات الست الأولى: تحليل PESTEL وPorter's Five Forces وSWOT وTOWS وValue Chain بمساعدة AI؛ بناء السيناريوهات وخرائط الفرص؛ OKRs وKPIs وBalanced Scorecards وخرائط الطريق ولوحات المتابعة. الحكم أولًا، والتسريع ثانيًا."
    },
    {
  ...
  "testimonials": [
   {
    ...
    "name": "منة",
    "role": "مشاركة في راوند سابقة",
    "initials": "M"
   },
   {
    "quote": "مش هتكلم عن جمال الشرح وقد إيه هو مبسّط. كل بوينت نتناقش فيها سوا ونفهم، والمهندس بيحب يسمع الآراء كلها. وكل بوينت كنا بناخدها بنطبّق عليها ونتناقش في اللي عملناه.",
    "name": "ملك",
    "role": "مشاركة في راوند سابقة",
    "initials": "M"
   },
   {
    "quote": "بجد سيشنز المهندس فؤاد من أكتر السيشنز اللي كنت مستمتعة بيها في البروجرام. أسلوبه سلس جدًا في الشرح، وبيعيدلنا كذا مرة ومش بيمل مننا خالص.",
    "name": "مريم محمد صلاح",
    "role": "مشاركة في راوند سابقة",
    "initials": "MS"
   },
   {
    "quote": "دكتور فؤاد حقيقي كان شخص inspiring جدًا لينا، وأسلوبه وطريقته والتعاون كان على قدر كبير.",
    "name": "فاطمة الزهراء",
    "role": "مشاركة في راوند سابقة",
    "initials": "FA"
   },
   {
    "quote": "ألف شكر للتنظيم الجميل والمادة العلمية الرائعة. حقيقي الواحد استفاد، وتنظيم التفكير بصفة عامة ممتاز.",
    "name": "م. يوسف حسن",
    "role": "مشارك في راوند سابقة",
    "initials": "YH"
   },
   {
    "quote": "شكر خاص لدكتور أحمد مغربي على سهولة المعلومة وتمام وضوحها، وشكرًا لكل الناس اللي ساعدت إن الكورس يطلع بالشكل الجميل ده.",
    "name": "أحمد شامة",
    "role": "مشارك في راوند سابقة",
    "initials": "AS"
   }
